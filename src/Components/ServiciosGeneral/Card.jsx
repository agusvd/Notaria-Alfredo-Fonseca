...
const Card = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto mt-10 flex flex-col justify-center items-center font-primary' id='servicios'>
            ...
            <motion.div variants={container} initial="hidden" whileInView="visible" className='mt-10 grid grid-cols-1 md:grid-cols-2 justify-center items-center md:gap-y-20 md:gap-x-8 gap-y-20 p-10'>
                ...
                <div className='overflow-hidden rounded-xl bg-white hover:shadow-lg hover:shadow-teal-500 hover:sm:scale-105 w-96 duration-300 transition-all ease-in-out'>
                    <div className='flex items-center justify-center h-[240px] w-full overflow-hidden'>
                        <img src="https://media.ambito.com/p/b79eaecc59ff201461f7d30b6ee9cb88/adjuntos/239/imagenes/039/503/0039503313/firma-digitaljpg.jpg" className="h-full w-full" />
                    </div>
                    <div>
                        <div className='flex items-center justify-around gap-2 text-3xl bg-white p-2 text-teal-500 h-20'>
                ...
                <div className='overflow-hidden rounded-xl bg-white hover:shadow-lg hover:shadow-teal-500 hover:sm:scale-105 w-96 duration-300 transition-all ease-in-out'>
                    <div className='flex items-center justify-center h-[240px] w-full overflow-hidden'>
                        <img src="https://global-uploads.webflow.com/61388d0210d654c3910bea20/620fb6d688913b53195259f1_guia-practica-para-tramitar-una-herencia-notaria-jbl.jpg" className='h-full w-full' />
                    </div>
                    <div>
                        <div className='flex items-center justify-around gap-2 text-3xl bg-white p-2 text-teal-500 h-20'>
            ...
            <Modal isVisible={showModal2} onClose={() => setShowModal2(false)}>
                ...
                <p className='text-justify p-2 text-red-500 text-lg'>Aqui puede verificar su documento.</p>
                    ...
                    <ol className="list-decimal list-inside space-y-4">
                        {steps.map((step, index) => (
                            <li className="flex flex-col" key={index}>
                                ...
                                <button className="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-600 w-32"
